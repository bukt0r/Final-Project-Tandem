export const en = {
  ...
  statistics: {
    ...
    learningTitle: 'Overall learning',
    learned: 'Learned',
  ...
  auth: {
    ...
    errorExists: 'A user with this name already exists',
    errorInvalid: 'Username — at least 2 chars, password — at least 4',
    logout: 'Log out',
    welcome: 'Welcome to Tech Interview Trainer!',
    welcomeDescription: 'Sign in or create an account so your progress is saved.',
  },
  theme: {
